    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<Product> CreateProduct(CreateProductModel model)
        {
            ...
            if(model.File!=null)
            {
                ...
                path = await file.SaveAndResize(model.File, _appEnvironment.WebRootPath);
            }
        ...
        {
            return await _context.Products.AsNoTracking().OrderBy(x=>x.Id).Include(x=>x.Category).ToListAsync();
        }
